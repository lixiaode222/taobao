                        ...
                        <span class="product-title">
                           <a target="_blank" href="{{ route('products.show', [$item->product_id]) }}">{{ $item->product->title }}</a>
                                                    ...
                                                    @if($index === 0)
                                                        ...
                                                        <td rowspan="{{ count($order->items) }}" class="text-center"><a class="btn btn-primary btn-sm" style="background-color: #ff8134;border-color: #ff8134" href="{{ route('orders.show', ['order' => $order->id]) }}">查看订单</a></td>
                                                    @endif
                                                </tr>
                                            @endforeach
                                        </table>
