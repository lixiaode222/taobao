                        ...
                        <div class="order-summary text-right">
                            ...
                            @if(!$order->paid_at && !$order->closed)
                                <div class="payment-buttons">
                                    <a class="btn btn-primary btn-sm" style="background-color: #ff8134;border-color: #ff8134" href="{{ route('payment.alipay', ['order' => $order->id]) }}">支付宝支付</a>
                                </div>
                            @endif
                            <!-- 支付按钮结束 -->
                            ...
                            @if($order->ship_status === \App\Models\Order::SHIP_STATUS_DELIVERED)
                                <div class="receive-button">
                                    <!-- 将原本的表单替换成下面这个按钮 -->
                                    <button type="button" style="background-color: #ff8134;border-color: #ff8134" id="btn-receive" class="btn btn-sm btn-success">确认收货</button>
                                </div>
                            @endif
